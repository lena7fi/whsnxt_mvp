...
const yearDropdownItems = new Array(60).fill(0).map((e, i) => ({ label: (2019 - i).toString(), value: (2019 - i).toString() }));
...
function StyledInput({ label, type, onChangeText, value, autoFocus, width, isPassword }) {
  return (
    <View style={styles.Group4}>
      ...
      <View style={styles.Rectangle14_}>
        <TextInput
          style={{ color: 'white', width: '100%', textAlign: 'center', height: '100%', fontSize: 12 }}
...
export default function SignUp({ navigation }) {
  ...
  useEffect(() => {
    let daysLength = daysInMonth(birthMonth?parseInt(birthMonth)+1:birthMonth, parseInt(birthYear)+1);
    console.log("daysLength", daysLength);
    setDayDropdownItems(new Array(daysLength).fill(0).map((e, i) => ({ label: (i+1).toString(), value: (i+1).toString() })))
      ...
      <View style={styles.Group579}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ marginTop: 15}}>
            ...
            <Dropdown
               style={[styles.dropdown2, isGenderFocus && { borderColor: 'blue' }]}
               placeholderStyle={styles.placeholderStyle}
               selectedTextStyle={styles.selectedTextStyle}
               inputSearchStyle={styles.inputSearchStyle}
               data={genderItem}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <Dropdown
               style={[styles.dropdown2, isGenreFocus && { borderColor: 'blue' }]}
               placeholderStyle={styles.placeholderStyle}
               selectedTextStyle={styles.selectedTextStyle}
               inputSearchStyle={styles.inputSearchStyle}
